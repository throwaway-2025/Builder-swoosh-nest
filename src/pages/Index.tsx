    ...
    <div className="w-full max-w-4xl mx-auto px-4">
      ...
      <div className="md:hidden">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-lg text-sm font-medium focus:border-gray-400 focus:ring-0"
              />
            </div>
            <div className="space-y-2">
              <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wide">
          ...
          {/* Search Button */}
          <Button className="w-full bg-gradient-to-r from-gray-800 to-black hover:from-gray-900 hover:to-gray-800 text-white py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02]">
